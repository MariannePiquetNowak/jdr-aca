...
console.log(content)
    ...
    // Fonction pour générer le sommaire enrichi (copiée depuis Regles)
    ...
    // Fonction pour convertir le Markdown basique en HTML (identique à Regles)
    ...
    return (
        <main className="main info-page" style={{paddingTop: viewMode === 'book' && !isEditing ? '1rem' : '2rem'}}>
            {isEditing && (
                <h1 style={{marginBottom: '2rem'}}>📚 Lore & Histoire</h1>
            )}
